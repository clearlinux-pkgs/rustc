...
Source0  : https://static.rust-lang.org/dist/rustc-1.74.0-src.tar.gz
Source1  : https://static.rust-lang.org/dist/rustc-1.74.0-src.tar.gz.asc
Summary  : unknown
...
%prep
%setup -q -n rustc-1.74.0-src
cd %{_builddir}/rustc-1.74.0-src
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a rustc-1.74.0-src buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700165287
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libLLVM-17-rust-1.74.0-stable.so
/usr/lib64/libLLVM-17-rust-1.74.0-stable.so
