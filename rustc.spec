...
Source0  : https://static.rust-lang.org/dist/rustc-1.74.1-src.tar.gz
Source1  : https://static.rust-lang.org/dist/rustc-1.74.1-src.tar.gz.asc
Summary  : unknown
...
%prep
%setup -q -n rustc-1.74.1-src
cd %{_builddir}/rustc-1.74.1-src
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
pushd ..
cp -a rustc-1.74.1-src buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702961387
...
cp %{_builddir}/rustc-%{version}-src/vendor/anstyle-1.0.1/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/rustc/669a1e53b9dd9df3474300d3d959bb85bad75945 || :
cp %{_builddir}/rustc-%{version}-src/vendor/anstyle-1.0.1/LICENSE-MIT %{buildroot}/usr/share/package-licenses/rustc/f911b0506e6ba6a56b4edac717b461799f380ef0 || :
...
cp %{_builddir}/rustc-%{version}-src/vendor/bitflags-2.3.3/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/rustc/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/rustc-%{version}-src/vendor/bitflags-2.3.3/LICENSE-MIT %{buildroot}/usr/share/package-licenses/rustc/9f3c36d2b7d381d9cf382a00166f3fbd06783636 || :
...
cp %{_builddir}/rustc-%{version}-src/vendor/byteyarn/LICENSE.md %{buildroot}/usr/share/package-licenses/rustc/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
...
cp %{_builddir}/rustc-%{version}-src/vendor/rustix-0.38.6/LICENSE-APACHE %{buildroot}/usr/share/package-licenses/rustc/5798832c31663cedc1618d18544d445da0295229 || :
cp %{_builddir}/rustc-%{version}-src/vendor/rustix-0.38.6/LICENSE-Apache-2.0_WITH_LLVM-exception %{buildroot}/usr/share/package-licenses/rustc/f137043e018f2024e0414a9153ea728c203ae8e5 || :
cp %{_builddir}/rustc-%{version}-src/vendor/rustix-0.38.6/LICENSE-MIT %{buildroot}/usr/share/package-licenses/rustc/ce3a2603094e799f42ce99c40941544dfcc5c4a5 || :
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libLLVM-17-rust-1.74.1-stable.so
/usr/lib64/libLLVM-17-rust-1.74.1-stable.so
